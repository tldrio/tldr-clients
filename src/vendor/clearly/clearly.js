define(['jquery'], function($) {
  ...
  $R.getContent__exploreNodeAndGetStuff = function (_nodeToExplore, _justExploring)
    ...
    $R.getContent__find = function ()
    {
      ...
      _aboveNodes = []
      ;
      //console.log('in getContent__find');
      ...
      ;
      //console.log(_foundHTML);
      //console.log('document title', _documentTitle);
      ...
      if ($R.articleTitle > ''); else
        ...
        $R.foundHTML = _foundHTML;
        $R.foundNode = _found._firstCandidate.__node;
